...
class Config:
    ...
    env_height: Annotated[int, 'Height of Karel environment.'] = 16 #8 for stairclimber, 16 for maze
    env_width: Annotated[int, 'Width of Karel environment.'] = 16 #8 for stairclimber, 16 for maze
