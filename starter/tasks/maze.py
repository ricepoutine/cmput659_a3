...
class Maze(Task):
    ...
    def generate_state(self):
        ...
        self.initial_distance = 0 #spatial.distance.cityblock(init_pos, self.marker_position)
        self.previous_distance = 0 #self.initial_distance
    ...
    def get_reward(self, world_state: World):
        ...
        current_distance = 0#spatial.distance.cityblock([karel_pos[0], karel_pos[1]], self.marker_position)
